...
INSERT INTO article (title, date, test_explain, answer, input_example, output_example, speed, code_explain, concept, user_no, algorithm_no, difficulty_no, language_no, previoustest_no) VALUES ('제목1', '2020-1-20', '테스트 설명1', '정답1', 'input1', 'output1', '20ms', '코드 설명1', '컨셉1', 1, 1, 1, 1, 1);
INSERT INTO article (title, date, test_explain, answer, input_example, output_example, speed, code_explain, concept, user_no, algorithm_no, difficulty_no, language_no, previoustest_no) VALUES ('제목2', '2020-2-20', '테스트 설명2', '정답2', 'input2', 'output2', '22ms', '코드 설명2', '컨셉2', 2, 2, 1, 1, 3);
INSERT INTO article (title, date, test_explain, answer, input_example, output_example, speed, code_explain, concept, user_no, algorithm_no, difficulty_no, language_no, previoustest_no) VALUES ('제목3', '2020-3-20', '테스트 설명3', '정답3', 'input3', 'output3', '24ms', '코드 설명3', '컨셉3', 3, 1, 3, 1, 1);
INSERT INTO article (title, date, test_explain, answer, input_example, output_example, speed, code_explain, concept, user_no, algorithm_no, difficulty_no, language_no, previoustest_no) VALUES ('제목4', '2020-4-20', '테스트 설명4', '정답4', 'input4', 'output4', '26ms', '코드 설명4', '컨셉4', 4, 1, 2, 4, 1);
INSERT INTO article (title, date, test_explain, answer, input_example, output_example, speed, code_explain, concept, user_no, algorithm_no, difficulty_no, language_no, previoustest_no) VALUES ('제목5', '2020-5-20', '테스트 설명5', '정답5', 'input5', 'output5', '28ms', '코드 설명5', '컨셉5', 1, 1, 3, 1, 2);